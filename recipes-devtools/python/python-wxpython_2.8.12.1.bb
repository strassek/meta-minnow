...
do_compile() {
    ...
    ${STAGING_BINDIR_NATIVE}/python-native/python setup.py build_ext -inplace ${EXTRA_SETUP}
...
do_install() {
    ...
    export STAGING_INCDIR=${STAGING_INCDIR}
    BUILD_SYS=${BUILD_SYS} HOST_SYS=${HOST_SYS} \
    ${STAGING_BINDIR_NATIVE}/python-native/python setup.py install_data ${EXTRA_SETUP}
